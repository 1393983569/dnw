    ...
    <div v-if="showAddData">
      <Modal
        ...
        <Row class="m_left">
          <Col span="11">
            <div>
              <span>姓名:  </span><Input v-model="cusName" placeholder="顾客姓名" style="width: 200px; margin-right: 5px"/>
        ...
        <div v-if="!stateEcho">
          <span>顾客备注:  </span><Input v-model="remark" placeholder="备注" type="textarea" style=" display: inline-block"/>
